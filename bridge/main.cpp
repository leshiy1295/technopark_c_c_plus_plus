/* 
 * пример из https://github.com/IlyaSaneev/technopark_cpp.git
 */
...
struct ST_LoggerImpl : public LoggerImpl {
  void console_log(string &str) { std::cout << "ST == " << str << std::endl; };

  virtual void file_log(const std::string& str) {};
  virtual void socket_log(const std::string& str) {};
};

struct MT_LoggerImpl : public LoggerImpl {
  void console_log(string &str) { std::cout << "MT == " << str << std::endl; };
  virtual void file_log(const std::string& str) {};
  virtual void socket_log(const std::string& str) {};
};
// --------------------------------
